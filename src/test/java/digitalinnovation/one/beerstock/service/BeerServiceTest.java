...
import digitalinnovation.one.beerstock.builder.BeerDTOBuilder;
...
//        // then
    ...
    @Test
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerMinimumStockException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenDecrementIsCalledToEmptyStockThenEmptyBeerStock() throws BeerNotFoundException, BeerMinimumStockException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    void whenDecrementIsLowerThanZeroThenThrowException() {
        ...
        assertThrows(BeerMinimumStockException.class, () -> beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement));
    }
